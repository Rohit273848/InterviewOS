...
6. atsKeywordAnalysis: An object containing:
   - matchedKeywords: Array of important keywords found in the JD that are present in the resume.
   - missingKeywords: Array of important keywords found in the JD that are missing from the resume.
...
7. additions: Array of objects indicating what should be added to the resume to optimize it:
   ...
   - example: Example content to add.
...
11. roadmap: An object containing a personalized, practical roadmap:
    - immediate: Array of action items for 1 day.
    - shortTerm: Array of action items for 1 week.
    - mediumTerm: Array of action items for 1 month.
    - longTerm: Array of action items for 3 months.
